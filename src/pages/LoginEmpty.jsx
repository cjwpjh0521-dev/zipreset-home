  ...
  return (
    <div className="screen" id="le-page">
      ...
      <div className="form-wrap">
        <input className="input-field" type="email" placeholder="아이디(이메일)를 입력해 주세요." />
        <input className="input-field" type="password" placeholder="비밀번호를 입력해주세요." />
      ...
      <div className="social-wrap">
        ...
        <button className="social-btn point">
          <span>P</span>
        </button>
